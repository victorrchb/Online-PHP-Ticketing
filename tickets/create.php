...
<body>
    ...
    <main class="center-container create-event-container create-modify-event">
        ...
        <form method="POST" class="register-content">
            ...
            <input class="input-tag" type="text" id="firstname" name="firstname" placeholder="John" required>
            <label for="lastname" class="label-tag">Nom*</label>
            <input class="input-tag" type="text" id="lastname" name="lastname" placeholder="Doe" required>
            <label for="mail" class="label-tag">Mail*</label>
            <input class="input-tag" type="email" id="mail" name="mail" placeholder="john.doe@gmail.com" required>
            <input class="submit" type="submit" value="Créer le billet">
        </form>
    </main>
<!-- 
    <main class="center-container create-event-container create-modify-event">
